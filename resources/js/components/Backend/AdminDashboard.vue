            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <router-link :to="{ name: 'admin-dashboard' }" tag="a" class="nav-link" active-class="active" exact>
                        ...
                        <li class="nav-item">
                            <router-link :to="{ name: 'admin-propertyback' }" tag="a" class="nav-link" active-class="active" exact>
                                <i class="nav-icon fas fa-home"></i>
                                <p>Property</p>
                            </router-link>
                        </li>
                        <li class="nav-item">
                            <router-link :to="{ name: 'admin-profile' }" tag="a" class="nav-link" active-class="active" exact>
                        ...
                        <li class="nav-item">
                            <router-link :to="{ name: 'admin-enquiry' }" tag="a" class="nav-link" active-class="active" exact>
