    ...
    <div>
        ...
        <div class="container">
            ...
            <section class="row justify-content-center m-auto property_details_searchbar">
                <div class="col-12 col-sm-12 col-md-10 col-lg-10 text-center bg-white mt-md-n5 mt-lg-n5 p-4 main_search_box">
            ...
            <section class="row w-100 mt-5 mb-5 ml-0 propety_details_title">
                <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                    <h3>{{property.title}}
                        <i v-if="$store.getters.isLoggedIn" class="fa-heart card-heart"
                           :class="getClassFavorites()" @click="changeHeart($event,property.id)"></i></h3>
            ...
            <div class="container ">
                ...
                <div class="row pt-3">
                    <div class="col-xl-3 col-md-6 col-lg-4 p-2"
                         v-for="(similar, index) in similar_property"
                         :key="similar.id">
                        <router-link :to="{ name:'singleproperty', params: {id: similar.id} }">
                            <div class="props card">
                                ...
                                <img class="card-img-top" alt="image"
                                     :src="getSimilarPropertyImage(index)">
                                <div class="card-body">
                                    <div class="row">
