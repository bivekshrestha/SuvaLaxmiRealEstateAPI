<template>
  <div>
    ...
    <div class="col-12 col-sm-12 col-md-5 col-lg-5 big_image">
      <img
              class="w-100 h-100"
              @click="lightboxEffect(0)"
              :key="thumbnails[0]"
              :src="thumbnailsPath + thumbnails[0]"
      >
    </div>
    ...
    <div class="col-12 col-sm-12 col-md-7 col-lg-7 image-grid">
      <img
              ...
              class="light-box__thumbnail col-12 col-sm-12 col-md-6 col-lg-6 w-100 small_images"
              alt="property-images"
      >
    </div>
    </div>
    ...
    <div v-if="bg" class="light-box-container">
      ...
      <button @click="prev" v-on:keyup.left="prev" class="light-box__prev light-box__btn"><i class="fas fa-chevron-left"></i></button>

      <div v-if="bg" class="light-box__container">
        <transition name="fade" mode="out-in">
          <img
            :key="currentImage"
            :src="largePath + currentImage"
            class="light-box__container__img lightbox_image"
          >
        </transition>
      </div>
      ...
      <button v-on:keyup.right="next" @click="next" class="light-box__next light-box__btn"><i class="fas fa-chevron-right"></i></button>
    </div>
  </div>
</template>
