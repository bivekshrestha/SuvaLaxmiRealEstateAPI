        ...
        <form @submit.prevent="$store.getters.isEdit?editProperty($route.params.id):createProperty()">
                ...
                <div class="col-12">
                    <div class="my-2 mb-3">
                        ...
                        <div id="property-type" class="d-flex flex-row my-3">
                            <input class="form-check-input" type="radio" value="residential" id="residential"
                                   name="type"
                                   v-model="form.type"
                                   v-bind:checked="checked">
                        ...
                        <div id="property-category" class="d-flex flex-row my-3">
                            <input class="form-check-input" type="radio" value="house" name="category" id="house"
                                   ...
                                   v-on:click="toggleThree('house')"
                                   v-bind:checked="checked"/>
                            <label class="form-check-label py-2 px-3 d-flex flex-column align-items-center justify-content-center"
                                   for="house">
                                <i class="fas fa-home"></i>
                                House
                            </label>
                            <input class="form-check-input" type="radio" value="land" id="land" name="category"
                                   v-on:click="toggleThree('land')"
                                   v-model="form.category"
                                   v-bind:checked="unchecked"/>
                            <label class="form-check-label py-2 px-3 ml-3 d-flex flex-column align-items-center justify-content-center"
                                   for="land">
                                <i class="fas fa-layer-group"></i>
                                Land
                            </label>
                            <input class="form-check-input" type="radio" value="apartment" id="apartment"
                                   name="category"
                                   v-on:click="toggleThree('house')"
                                   v-model="form.category"
                                   v-bind:checked="unchecked"/>
                        ...
                        <div class="form-row my-3">
                            <div class="col-sm-6 col-md-5 col-lg-4 mb-3">
                                ...
                                <input type="text" v-model="form.address" class="form-control"
                                       placeholder="Eg: New Road" name="address" id="address"
                        ...
                        <div v-show="house">
                            ...
                            <div class="form-row my-3">
                                ...
                                <div class="col-sm-6 col-md-5 col-lg-3 mb-2">
                                    ...
                                    <select class="form-control" v-model="form.built_year" id="builtYear"
                                            name="built_year"
                                ...
                                <div class="col-sm-6 col-md-5 col-lg-3 mb-2">
                                    ...
                                    <input type="number" v-model="form.floors" class="form-control" placeholder="Eg. 6"
                                           id="totalFloors" name="floors"
                                           :class="{ 'is-invalid': form.errors.has('floors')}">
                                ...
                                <div class="col-sm-6 col-md-5 col-lg-3 mb-2">
                                    ...
                                    <select class="form-control" v-model="form.furnish_status" id="furnished"
                                            name="furnish_status"
                                            :class="{ 'is-invalid': form.errors.has('furnish_status')}">
                        ...
                        <div class="form-row my-4">
                            ...
                            <div class="col-10 justify-content-center"
                                ...
                                <div class="drop display-inline align-center" @dragover.prevent @drop="onDrop">
                                    ...
                                    <div class="hidden display-inline align-center" v-else
                    ...
                    <div class="my-2">
                        ...
                        <div class="form-row my-3">
                           ...
                           <textarea v-model="form.description" class="form-control"
                                     placeholder="Few descriptions about your property" name="description"
                                     rows="6" :class="{ 'is-invalid': form.errors.has('description')}"></textarea>
            ...
            <div class="container-fluid my-2 py-3 border bg-light">
                <div class="col-12">
                    <div class="my-2">
                        <div class="form-row my-3">
                            <input type="hidden" v-model="form.owner_id" class="form-control"
                                   id="ownerEmail" name="owner_id"
...
<script>
    export default {
        ...
        methods: {
            ...
            onDrop: function (e) {
                e.stopPropagation();//stops bubble propagation
                e.preventDefault();
