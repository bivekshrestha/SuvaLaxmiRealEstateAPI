        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center property-container">
                    ...
                    <div class="mobile-filter">
                       ...
                       <span @click="toggle">Sort
                                    ...
                                    <ul class="toggleBtns">
                                        <li class="mr-2">
                                            <button class="btn btn-outline-primary btn-sm"
                                                    ...
                                                    v-on:click="toggleSaleRent('sale')">For Sale
                                            </button>
                                        </li>
                                        <li>
                                            <button class="btn btn-outline-primary btn-sm"
                                                    v-bind:class="{active:isInactive}"
                                                    v-on:click="toggleSaleRent('rent')">For Rent
                                            </button>
                                        </li>
                                    </ul>
                                </h6>
                        ...
                        <i class="fas fa-chevron-down slide-down-hover"></i>
                                ...
                                <!--enclose inside p tag for toggling buttons that you want-->
                                <h6 class="mt-2" style="display:none">
                                    <ul class="toggleBtns">
                                        <li class="mr-2">
                                            <button class="btn btn-outline-primary btn-sm"
                                ...
                                <div class="mt-2" style="display:none">
                                    <div class="d-flex flex-row input-group">
                                        <select class="form-control" name="location" id="location"
                                                ...
                                                v-model="form.location" @change="changeValue('location')">
                                        ...
                                        <div class="input-group-prepend"
                                             v-bind:class="{ 'hideShow': firstHidden }"
                        ...
                        <i class="fas fa-chevron-down slide-down-hover"></i>
                                ...
                                <h6 class="mt-2" style="display:none">
                                    <ul class="toggleBtns" id="corer">
                                        <li class="mr-2"
                                            v-for="crore in crores"
                                            :value="crore"
                                            :key="crore.id">

                                            <button class="btn btn-outline-primary btn-sm croreBtn"
                                                    @click="toggleCrore(crore.value)"
                                            >
                                                {{ crore.value }}
                                            </button>
                                        </li>
                                    ...
                                    <ul class="toggleBtns" id="road">
                                        <li class="mr-2"
                                            ...
                                            <button class="btn btn-outline-primary btn-sm roadBtn"
                                                    @click="toggleRoadType(roadType.value)"
                                            >
                                                {{ roadType.value }}
                                            </button>
                                        </li>
                        ...
                        <div class="tags">
                            <div v-for="(item,key,index) in filterValue" class="filter-tags" :key="item.key">
                    <span :key="index" class="badge badge-pill badge-primary  p-2 m-1"
                    >{{item}}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-xl-9 mobile-padding">
                    <div class="filter-header-container">
                        ...
                        <div class="input-group  dropdown-sort">
                            <select name="sortBy" class="form-control"
                                    @change="changeValue('sort')" v-model="sort">
                    ...
                    <!--pagination start-->
                    <pagination :data="properties" @pagination-change-page="getResults"
                                class="pagination-property"></pagination>
                    <!--pagination end-->
                </div>
            </div>
            <!-- let us know -->
        ...
        <div class="container-fluid mt-5">
            <div class="row text-center let-us-know  pt-5 pb-5 ">
                ...
                <div class="col-lg-6  let-us-know-btn">
                    <router-link to="/contact" tag="a" class="btn btn-info btn-sm text-white" style="padding: 13px" active-class="active" exact>
                        LET US KNOW
                    </router-link>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            toggle(event) {
                ...
                let val = parent.childNodes[2].style.display;
                if (val === "none") {
