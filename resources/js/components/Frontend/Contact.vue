        ...
        <div class="faq-section container">
            ...
            <div class="faq">
                <div class="question" @click="toggle">
                    <h5>What is this Website About? </h5>
                    <span>+</span>
                </div>
                <hr>
                <div class="answer">
                    <p>This website is a way to make selling and purchasing real estate in Nepal simple and more
                        accessible.</p>
                    <p>We let sellers list their property and provide them a platform to find buyers.</p>
                </div>
            </div>
            ...
            <div class="faq">
                <div class="question" @click="toggle">
                    <h5>When did this establish ? </h5>
                    <span>+</span>
                </div>
                <hr>
                <div class="answer">
                    <p>It is registered on 2012 in Kathmandu, Nepal.</p>
                </div>
            </div>
            ...
            <div class="faq">
                <div class="question" @click="toggle">
                    <h5>How can this help sell my property?</h5>
                    <span>+</span>
                </div>
                <hr>
                <div class="answer">
                    <p>Anyone who has property can submit their details through our website and it will be added in our
                        database and can be viewed by potential customers.</p>
                </div>
            </div>
            ...
            <div class="faq">
                <div class="question" @click="toggle">
                    <h5>How can I add My Property in the Website?</h5>
                    <span>+</span>
                </div>
                <hr>
                <div class="answer">
                    <p>All you need to do is open an account on our website. Then, you can start posting your property,
                        and thousands of potential customers will view your house, land or apartment.</p>
                </div>
            </div>
            <!--4-->
            <div class="faq">
                <div class="question" @click="toggle">
                    <h5>If I am an agent can I also add property which is on my contact to ShuvaLaxmi ?</h5>
                    <span>+</span>
                </div>
                <hr>
                <div class="answer">
                    <p>Yes you can sign up and add your property .</p>
                </div>
            </div>
        </div>
        <div class="contact mx-5 my-5">
            <div class="row">
                <div class="col-md-6 d-flex justify-content-center align-items-center">
                    <img src="/img/global/email.png" width="40%">
                </div>
