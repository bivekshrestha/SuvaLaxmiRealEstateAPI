    ...
    getAvatarImage: function getAvatarImage() {
      ...
      axios.get("/api/profile/" + this.$store.getters.currentUser.id).then(function (res) {
        ...
        if (_this.photo.length >= 1) {
          var photo = "/img/profile/" + _this.photo;
          console.log(photo);
        } else {
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "avatar", attrs: { id: "sidebar-img" } }, [
      _c("div", { staticClass: "image" }, [
        _c("img", {
          staticClass: "img-rounded w-100 h-100",
          attrs: { src: __webpack_require__(/*! ../../../../../../public/img/profileimg.jpg */ "./public/img/profileimg.jpg") }
        })
      ])
    ])
  }
...
module.exports = "/images/profileimg.jpg?782e21c8c4b78fd975fe17a434f0ba57";
