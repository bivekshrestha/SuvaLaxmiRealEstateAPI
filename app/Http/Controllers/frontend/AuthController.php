...
class AuthController extends Controller
{
    ...
    //account activate
    public function accountActivation($token): JsonResponse
    {
    ...
    //social lite
    public function SocialSignUp($provider): JsonResponse
    {
    ...
    public function socialLogin($user, $provider): JsonResponse
    {
